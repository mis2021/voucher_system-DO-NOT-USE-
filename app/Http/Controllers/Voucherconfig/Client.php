...
namespace App\Http\Controllers\Voucherconfig;
// namespace UniFi_API;
...
class Client
{
    ...
    protected $baseurl              = 'http://172.16.10.14:8443';
    protected $user                 = 'acemcb';
    protected $password             = 'p@$$word@@c3mc';
    protected $site                 = 'http://172.16.10.14:8443';
